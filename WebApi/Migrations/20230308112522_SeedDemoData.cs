...
namespace WebApi.Migrations
{
    public partial class SeedDemoData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            insert into Cars(Name,Price,SellRent,km,CitiesId,modelyear,FuelTypeId,carbrand,BodyTypeId,owner,state,cardesc,PostedOn,PostedBy,LastUpdatedOn,LastUpdatedBy)
            select 
            'Creta', --Name
            1800, --Price
            1, --Sell Rent
